...
1.0                  AirDens     - Air density (kg/m^3)
...
"../openfast_IEA-15-240-RWT/IEA-15-240-RWT_BeamDyn.dat"    BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../openfast_IEA-15-240-RWT/IEA-15-240-RWT_BeamDyn.dat"    BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"../openfast_IEA-15-240-RWT/IEA-15-240-RWT_BeamDyn.dat"    BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"../openfast_IEA-15-240-RWT/IEA-15-240-RWT_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
...
0.00025                   SttsTime    - Amount of time between screen status messages (s)
